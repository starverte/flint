...
?>
  ...
  <div class="row">
    ...
    <?php } ?>
    <article id="post-<?php the_ID(); ?>" <?php if (!is_active_sidebar('left') &&  !is_active_sidebar('right')) { post_class('col-lg-8 col-md-8 col-sm-8'); } else { post_class('col-lg-8 col-md-8 col-sm-8'); } ?>>
